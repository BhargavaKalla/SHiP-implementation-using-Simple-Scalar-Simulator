...
enum cache_policy {
  ...
  BIP,        /* LRU Insertion Policy */      
  DIP,         /* Dynamic Insertion Policy */    
  BRRIP,       /* Bimodal Re-Reference Interval Prediction policy*/     
  SRRIP,        /* Static Re-Reference Interval Prediction policy */   
  DRRIP,         /* Dynamic Re-Reference Interval Prediction policy */
  SHiP  	
};

/* dynamic set selection via Set Dueling under Dynamic Insertion Policy*/
enum dynamic_set_type 
{
	lru,		/* set dedicated to LRU policy */                       
	bip,		/* set dedicated to BIP policy */                      
	follower	/* follower set whose policy decided by PSEL counter */
};  


/* dynamic set selection via Set Dueling under Dynamic Re-Reference Interval Prediction policy*/
enum drrip_set_type 
{
	srrip,		/* set dedicated to SRRIP policy */                       
	brrip,		/* set dedicated to BRRIP policy */                      
  followerset	/* follower set whose policy decided by PSEL counter*/ 
};


typedef enum dynamic_set_type dynamic_set_type;
typedef enum drrip_set_type drrip_set_type;
...
struct cache_blk_t
{
  ...
  int RRPV_counter;     /*Re-Reference Prediction Value for each cache line*/
  int outcome;
...
struct cache_set_t
{
  ...
  enum dynamic_set_type dynamic_set_type; /*dynamic set type for DIP*/
  enum drrip_set_type drrip_set_type;      /*dynamic set type for DRRIP*/
}; 
...
struct cache_t
{
  ...
  int PSEL_counter;	        /* policy selection counter*/
  int PSEL_width;		/* width of the policy selection counter*/
  int BIP_counter;		/* BIP(Bimodal Insertion Policy) counter*/
  int BIP_width;		/* width of the BIP counter */
  int BRRIP_counter;   /* BRRIP (Bimodal Re-Reference Interval Prediction counter*/
